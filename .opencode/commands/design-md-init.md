...
3. Update **AGENTS.md** and **CLAUDE.md**:
   - For each file that exists, locate or create a block delimited by `<!-- DESIGN_SYSTEM_START -->` and `<!-- DESIGN_SYSTEM_END -->`.
   ...
   - If neither file exists, create `AGENTS.md` with the design system block.
